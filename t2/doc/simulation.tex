...
Figure~\ref{fig:Ex3_Image} shows the simulated transient analysis results obtained for the voltage in node 6.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\linewidth]{../sim/ex3_image.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\linewidth]{../sim/ex4_imagestimulus.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\linewidth]{../sim/ex4_imageforcedresponse.pdf}
